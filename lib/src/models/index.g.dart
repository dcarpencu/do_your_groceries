...
_$AppState$Impl _$$AppState$ImplFromJson(Map<String, dynamic> json) => _$AppState$Impl(
      ...
      products: (json['products'] as List<dynamic>?)?.map((e) => Auchan.fromJson(e as Map<String, dynamic>)).toList() ??
          const <Auchan>[],
      productsList:
          (json['productsList'] as List<dynamic>?)?.map((e) => Product.fromJson(e as Map<String, dynamic>)).toList() ??
              const <Product>[],
