...
class _$TakePictureSuccessfulImpl implements TakePictureSuccessful {
  const _$TakePictureSuccessfulImpl(this.picture, [this.pendingId = _kTakePicturePendingId]);
...
abstract class TakePictureSuccessful implements TakePicture, ActionDone {
  const factory TakePictureSuccessful(final XFile picture, [final String pendingId]) = _$TakePictureSuccessfulImpl;
